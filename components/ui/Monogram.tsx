interface MonogramProps {
  ...
  /** Solid filled monogram (default) oder Outline-Variante. */
  variant?:   'solid' | 'outline'
  strokeWidth?: number
}

/**
 * Braum-Consulting Monogramm als gefüllte Solid-Variante.
 * Fill nutzt `currentColor`, Farbe per `style.color` am Parent setzen.
 *
 * Aspect-Ratio ist 2:1 (viewBox 1000×500). Lass `width` oder `height`
 * über Style steuern und `aspectRatio` bleibt automatisch.
 */

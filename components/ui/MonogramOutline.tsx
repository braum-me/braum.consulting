interface MonogramOutlineProps {
  strokeWidth?: number
  className?: string
...
/**
 * Braum-Consulting Monogramm als Outline-SVG, inline gerendert.
 * Stroke nutzt `currentColor`, Color via `style.color` am Parent setzen.
 */
export default function MonogramOutline({
  strokeWidth = 2.5,
  className,
  style,
}: MonogramOutlineProps) {
  return (
    <svg
